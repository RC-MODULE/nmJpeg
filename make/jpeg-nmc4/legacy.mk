...
INC_DIRS         = -I$(ROOT)/include -I$(NMPP)/include -I"$(NEURO)/include"
SRC_DIRS         = 	$(ROOT)/src/common \
					$(ROOT)/src/nm 


#--------------  RELEASE/ALL config -------------------
AS               =asm 				 
AS_FLAGS         =-$(ARCH) -split_sir -nm2ms  $(INC_DIRS)
AS_FLAGS_C2ASM   =-$(ARCH) -split_sir -nm2ms  $(INC_DIRS)
CC               =nmcpp

CCPP_FLAGS       =-6405 -DNEURO -OPT2 -inline -Tc99
...
ifdef DEBUG      
TARGET           =$(OUT_DIR)/$(PROJECT).lib
CCPP_FLAGS       =-6405 -DNEURO -OPT0 -inline -debug 
CC_FLAGS         =$(CCPP_FLAGS) -Tc99
LIBS            :=
AS_FLAGS        +=-ga
BUILDER_FLAGS   +=-d0
